...
class Node {
  ...
  function knightsMove(x, y) {
    ...
    while (queue.length > 0) {
      ...
      if (row === y[0] && col === y[1]) {
        ...
        let message = `your path in ${distance} moves.`;
        console.log(message);
  ...
  console.log(knightsMove([4, 4], [4, 2]));
  console.log(knightsMove([0, 0], [1, 3]));
  console.log(knightsMove([2, 2], [4, 4]));
  console.log(knightsMove([3, 3], [1, 3]));
